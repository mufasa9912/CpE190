...
int main()
{
    ...
    {
        printf("Input device could not be found.\n"); 
        goto error;
    }
    ...
    if(data.recordArrayInverse == NULL)
    {
    ...
    if(chrInput == '0'){
        ...
        if(data.recordArrayInverseAmp1 == NULL)
        {
        ...
        if(data.recordArrayInverseAmp2 == NULL)
        {
        ...
        if(data.recordArrayInverseAmp3 == NULL)
        {
        ...
        if(data.recordArrayInverseAmpNeg1 == NULL)
        {
        ...
        if(data.recordArrayInverseAmpNeg2 == NULL)
        {
        ...
        if(data.recordArrayInverseAmpNeg3 == NULL)
        {
    ...
    if(file == NULL)
    {
        printf("Could not open file '_recordArrayInit.raw'\n");
    }
    else 
    {
    ...
    if(file == NULL)
    {
        printf("Could not open file '_recordArrayInverseInit.raw'\n");
    }
    else
    {
